...
import com.glitchstacks.musiczone.SearchPageRecycler.ConcertAdapter;
import com.glitchstacks.musiczone.SearchPageRecycler.ConcertObject;
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if(snapshot.exists()){
                        ...
                        for (DataSnapshot ds : snapshot.getChildren()){
                            ...
                            viewer = Integer.parseInt(ds.child("viewer").getValue().toString());
